       ...
       <div class="box-body">
         <form action="{{route('product.save')}}" method="POST" enctype="multipart/form-data">
             ...
             <div class="form-group">
                 ...
                 <div class="controls">
                     <input type="text" name="product_name_english" class="form-control" value=""required="" data-validation-required-message="This field is required"> <div class="help-block"></div>
             </div></div>
              </div>
               <div class="col-md-3 col-12">
             <div class="form-group">
                ...
                <div class="controls">
                    <input type="text" name="product_name_arabic" class="form-control" value=""required="" data-validation-required-message="This field is required"> <div class="help-block"></div>
            </div></div></div>
            <div class="col-md-3 col-12">
            <div class="form-group">
                <h5>product code  <span class="text-danger">*</span></h5>
                <div class="controls">
                    <input type="text" name="product_code" class="form-control" value=""required="" data-validation-required-message="This field is required"> <div class="help-block"></div>
            </div></div></div>
            ...
            <div class="form-group">
              ...
              <div class="controls">
                <input type="text" name="product_quantity" class="form-control" value=""required="" data-validation-required-message="This field is required"> <div class="help-block"></div>
        </div></div>
...
<input type="text" name="product_tags_en" class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput">
    ...
    <div class="col-md-4">
       ...
       <div class="controls">
    <input type="text" name="product_tags_arabic" class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput">
         </div></div> </div>
...
<div class="row">
   ...
   <div class="controls">
<input type="text" name="product_size_arabic" class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput">
     </div></div> </div>
    ...
    <div class="col-md-4">
       ...
       <div class="controls">
    <input type="text" name="product_color_arabic" class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput">
         </div></div> </div>
    ...
    <div class="row">
       ...
       <div class="form-group">
           ...
           <div class="controls">
               <input type="text" name="silling_price" class="form-control" value=""required="" data-validation-required-message="This field is required"> <div class="help-block"></div>
       </div></div>
        </div>
         <div class="col-md-3 col-12">
       <div class="form-group">
          ...
          <div class="controls">
              <input type="text" name="descount_price" class="form-control" value=""required="" data-validation-required-message="This field is required"> <div class="help-block"></div>
      </div></div></div>
      <div class="col-md-3">
...
<textarea name="short_descp_en" id="textarea" class="form-control" required placeholder="Textarea text"></textarea>
     ...
     <div class="form-group">
        ...
        <div class="controls">
<textarea name="short_descp_arabic" id="textarea" class="form-control" required placeholder="Textarea text"></textarea>
          </div>
    </div></div></div>
...
<div class="form-group">
    ...
    <div class="controls">
<textarea id="editor1" name="long_descp_english" rows="10" cols="80">
...
<div class="col-md-6">
    ...
    <div class="form-group">
        ...
        <div class="controls">
    <textarea id="editor2" name="long_descp_arabic" rows="10" cols="80">
...
<div class="col-md-3">
	<div class="form-group">
		...
		<div class="controls">
			<fieldset>
				<input type="checkbox" id="checkbox_3" name="hot_deal" value="1">
            ...
            <fieldset>
				<input type="checkbox" id="checkbox_6" name="special_offer" value="1">
